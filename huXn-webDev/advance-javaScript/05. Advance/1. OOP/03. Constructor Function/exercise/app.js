...
function Person(name, age, gender) {
  ...
  this.info = function () {
    return `Hello my name is ${this.name} I'am ${this.age} & I'am a ${this.gender}`
  };
}


const fakbo = new Person("Fakbo", 20, "Male");

console.log(fakbo.info());
...
const car1 = new Car("Toyota", "Camry", "2005", "red");
const car2 = new Car("Honda", "CR-V", "2009", "Green");
